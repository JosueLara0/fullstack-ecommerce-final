...
// Send error format in Development environment
...
// Send error format in Production environment
const sendErrorProd = (error, req, res, next) => {
...
const globalErrorHandler = (err, req, res, next) => {
  ...
  // Validate which production environment is used
