...
exports.createProduct = catchAsync(async (req, res, next) => {
  ...
  // Save imgs path with multerUpload.fields
  ...
  // ! Save img path with multerUpload.single
  // const imgName = `/img/products/${newProduct.id}-${currentUser.id}-${req.file.originalname}`;
  // const imgRef = ref(firebaseStorage, imgName);
...
exports.getUserProducts = catchAsync(async (req, res, next) => {
  // Based on req.currentUser, get the user's product based on its id
